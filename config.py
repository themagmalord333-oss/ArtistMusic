...
class Config:
    def __init__(self):
        ...
        # Images
        self.DEFAULT_THUMB: str = getenv("DEFAULT_THUMB", "https://i.ibb.co/F4JRHBzr/x.jpg")
        self.PING_IMG: str = getenv("PING_IMG", "https://i.ibb.co/F4JRHBzr/x.jpg")
        self.START_IMG: str = getenv("START_IMG", "https://i.ibb.co/F4JRHBzr/x.jpg")
        self.RADIO_IMG: str = getenv("RADIO_IMG", "https://i.ibb.co/F4JRHBzr/x.jpg")
